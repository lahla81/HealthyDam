...
export type SignUpSuccess = ActionWithPayload<USER_ACTION_TYPES.SIGN_UP_SUCCESS, {user: User, additionalDetailes: AdditionalInformation}>
...
export const signUpSuccess = withMatcher((user: User, additionalDetailes:AdditionalInformation): SignUpSuccess => 
